<?php $this->load->view('layout/header.php') ?>
			<ul class="breadcrumb">
				...
				<li><a href="#">Edit Data Pengguna</a></li>
			</ul>

			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Edit Data Pengguna</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/Pengguna/saveEeditPengguna/">
							...
							<fieldset>
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" id="username" cols="90" rows="3" name="username" value="<?php echo $pengguna->username;?>">
							  </div>
							</div>
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" id="password" cols="90" rows="3" name="password" value="<?php echo $pengguna->password;?>">
							  </div>
							</div>
