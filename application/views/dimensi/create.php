            ...
            <form class="form-horizontal" method="POST" action="<?php echo base_url('Dimensi/process'); ?>">
                ...
                <!-- <?php echo validation_errors(); ?> -->
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge focused" id="dimensi" type="text" value="" name="dimensi">
                            <span style="color:red;"><?= form_error('dimensi') ?></span>
                            <!-- <input type="hidden" value="" name="id_dimensi" id="id_dimensi"> -->
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="focusedInput">Bobot : </label>
                        <div class="controls">
                            <input class="input-xlarge focused" id="bobot" type="text" value="" name="bobot">
                            <span style="color:red;"><?= form_error('bobot') ?></span>
                        </div>
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="simpan">Save changes</button>
                        <a class="btn" href="<?php echo base_url('Dimensi/create'); ?>">Cancel</a>
                    </div>
                </fieldset>
            </form>
        </div>
